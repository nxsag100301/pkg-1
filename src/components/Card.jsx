...
function Card({ image, title, description, url, date }) {
  ...
  return (
    <div
      className='border border-border-card w-full md:w-full lg:w-[90%] 2xl:w-[392px]  rounded-xl
    ...
    >
      <img
        src={image}
        alt='Card image'
        className='w-full h-[253px] object-cover md:object-[center_20%] md:h-[300px] lg:h-[253px] rounded-t-xl'
      />
